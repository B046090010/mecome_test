(function($) {
  ...
  $("#datepickere").on('click', function(e) {
  ...
  $("#scountry").on('change',function(e){
    ...
    for(var i in country[val]){
      temp=temp+"<option>"+country[val][i]+"</option>"
    }
    $("#stown").html(temp);
    $('#stown').selectpicker('refresh');
  });

  $("#smain").on('change',function(e){
    var val = $(this).val();
    var temp="<option>-</option>"
    var middle=
    {
    ...
    for(var i in middle[val]){
      temp=temp+"<option>"+middle[val][i]+"</option>"
    }
    $("#smiddle").html(temp);
  ...
  $("#send").on('click', function(e) {
    var start,end,sarea,scountry,stown,smain,smiddle,sdetail;
